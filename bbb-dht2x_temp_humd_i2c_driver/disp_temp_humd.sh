...
name=$(basename $0)
drv=dht2x_kdrv
# On the TI BBB (Beagle Bone Black), our DTS overlay defines the DHT2X chip
# to be on I2C bus #2 (as this is the I2C bus enabled in the default pinmux mode 2)
i2cbus=2        # on I2C bus #2; update if required
